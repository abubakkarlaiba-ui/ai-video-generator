        ...
        <div className="mt-20 grid gap-8 md:grid-cols-3">
          {TESTIMONIALS.map((testimonial, index) => (
            <AnimatedWrapper key={testimonial.name} delay={index * 0.1}>
              <div className="glass-card group relative flex h-full flex-col overflow-hidden p-8 transition-all duration-500 hover:bg-white/[0.06]">
                ...
                <Quote className="mb-5 h-7 w-7 text-violet-400/25" />
                ...
                <blockquote className="body-small flex-1 text-white/60">
                ...
                <div className="mt-8 flex items-center gap-3 border-t border-white/5 pt-6">
                  ...
                  <div>
                    ...
                    <p className="body-small text-white/40">{testimonial.role}</p>
                  </div>
                </div>
              </div>
            </AnimatedWrapper>
